...
class PlayerInfo {
    public:
        ...
        PlayerJointControlKeeper *pJoinControlKeeper; // 0x50
        ...
        struct PlayerJudgeStartJumpHakoniwa* pJudgeStartJumpHakoniwa;
        struct PlayerJudgeStartWaterSurfaceRun* pJudgeStartWaterSurfaceRun;
};